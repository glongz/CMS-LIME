...
4. `create_label_tgt_classification.py` - SOP/SPH segment labels (set SOP/SPH to **30 / 1** to match the paper tables)
...
Vendored from [DongDongBan/chbmit-seizure-prediction](https://github.com/DongDongBan/chbmit-seizure-prediction), with attribution. This folder was previously named `dataset_specific`. Siena preprocessing lives in `siena/` in this same repository.
