...
def main():
    input_file = Path(
        r"D:\2025_important_projects\paper-main\后处理过程改进\表格\patient23_chaos_BIOT_03-25.csv" # patient23_chaos_ATCNet_03-25.csv patient23_chaos_ATCNet_oral_03-25.csv
    )
